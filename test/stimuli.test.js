...
test("the rating text contains prior paragraph, QUD paragraph, and target answer", () => {
  ...
  assert.match(stimulus, /He asked their other roommate, who usually knew what was going on around the apartment, whether Catherine had TRIED TO pick up the package/);
  assert.match(
    stimulus,
